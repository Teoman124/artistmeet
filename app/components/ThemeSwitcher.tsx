...
export function ThemeSwitcher() {
    ...
    if (!mounted) {
        return (
            <div className="w-24 h-8 rounded-full bg-neutral-200 dark:bg-neutral-700 animate-pulse"></div>
        );
    }
        ...
        <div className="flex items-center gap-1 p-1 rounded-full bg-neutral-100 dark:bg-neutral-800">
            <button
                ...
                className={`p-1.5 rounded-full transition-all ${theme === 'light'
                        ? 'bg-white text-yellow-500 shadow-sm dark:bg-neutral-700'
            ...
            <button
                ...
                className={`p-1.5 rounded-full transition-all ${theme === 'system'
                        ? 'bg-white text-blue-500 shadow-sm dark:bg-neutral-700'
                        : 'text-neutral-500 hover:text-neutral-700 dark:text-neutral-400'
                    }`}
            ...
            <button
                ...
                className={`p-1.5 rounded-full transition-all ${theme === 'dark'
                        ? 'bg-white text-indigo-500 shadow-sm dark:bg-neutral-700'
                        : 'text-neutral-500 hover:text-neutral-700 dark:text-neutral-400'
                    }`}
