                ...
                {isOpen && (
                    <div className="absolute right-0 top-full z-20 mt-3 w-56 overflow-hidden rounded-2xl border border-black/10 bg-white shadow-lg dark:border-white/10 dark:bg-neutral-950">
                        ...
                        <div className="flex flex-col p-2 text-sm">
                            <Link href="/messages" onClick={() => setIsOpen(false)} className="rounded-xl px-3 py-2 text-left hover:bg-neutral-100 dark:hover:bg-white/10 flex items-center gap-2">
                                <span>💬</span>
                                <span>Messages</span>
                            </Link>
